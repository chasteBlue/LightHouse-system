...
import { IoAdd, IoSearchCircle, IoLocate} from 'react-icons/io5';
         ...
         <div className="columns" style={{minHeight:"100vh"}}>
            ...
            <div style={{ marginBottom: "5px" }}>
                <div className="staff-space">
                    ...
                    <IoLocate style={{ marginRight: '5px', textAlign: 'center' }} />
                ...
                <main className="section-p1">
                    ...
                    <div>
                        <div className="columns is-vcentered">
                            ...
                            <div className="column">
                                <div className="staff-space">
                                    <h3 className='subtitle'>Venue ID : </h3>
                                        <div className="field">
                        ...
                        <div className="columns">
                            ...
                            <div className="columns">
                                <h1 className="subtitle">
                                    <strong>Event Venue Information</strong>
                                </h1>
                            </div>
