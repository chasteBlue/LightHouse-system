...
import { IoHome,IoPerson, IoChevronBack,  IoChevronForward,  IoListOutline, IoFastFoodOutline, IoWalkOutline, IoGrid, IoGridOutline, IoMailOpenOutline} from 'react-icons/io5';
        ...
        <aside className='aside-space' style={{ transition: 'width 0.3s', position: 'relative' }}>
            ...
            <nav className='menu'>
                ...
                <p className='menu-label' style={{ display: isSidebarOpen ? 'block' : 'none' }}> Tables </p>
                    <ul className='menu-list'>
                        <li>
                            <Link to="/restaurant_table_maintenance">
